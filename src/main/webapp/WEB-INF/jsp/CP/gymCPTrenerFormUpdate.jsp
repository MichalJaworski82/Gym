...
<div class="container-fluid cf">
    ...
    <div class="section-light">
        ...
        <div class = "row">
            <div class ="col-sm-12">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <p class="lead">TRAINER UPDATE FORM</p>
                        <p class="lead">Admin only Access</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form:form action ="updateTrener" modelAttribute="trener" method ="POST">
        ...
        <div class="form-row">
            ...
            <div class="col-md-3">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        <c:forEach var="spec" items="${specList}">
                            <c:url var ="dodajSpecLink" value ="/dodajSpecDoTrenera">
                ...
                <ul class="list-group">
                    <c:forEach var="specjalizacja" items="${trener.listaSpecjalizacji}">
                        <c:url var ="usunSpecLink" value ="/usunSpecZTrenera">
                            <c:param name="trenerEmail" value = "${trener.email}" />
            ...
            <div class="form-row">
                ...
                <div class="col-md-1">
                    <button type="submit" class="btn btn-secondary">Update trainer</button>
                </div>
            </div>
